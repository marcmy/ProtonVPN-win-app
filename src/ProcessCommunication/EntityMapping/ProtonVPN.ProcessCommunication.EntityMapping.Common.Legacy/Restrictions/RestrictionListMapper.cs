...
public class RestrictionListMapper : IMapper<RestrictionsList, RestrictionListIpcEntity>
{
    ...
    public RestrictionListIpcEntity Map(RestrictionsList leftEntity)
    {
        return new()
        {
    ...
    public RestrictionsList Map(RestrictionListIpcEntity rightEntity)
    {
        return new()
        {
